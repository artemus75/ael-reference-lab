...
resource "proxmox_virtual_environment_vm" "talos" {
  ...
  # Dedicated persistent data disk.
  #
  # This disk is intentionally separated from the Talos system disk.
  # It provides the storage boundary for Management Plane platform data
  # such as central observability.
  disk {
    datastore_id = local.vm_baseline.datastore_id
